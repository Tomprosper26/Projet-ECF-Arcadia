                                ...
                                <?php if ($habitat['id'] == $animal['habitat_id']) : ?>
                                    <div class="card p-0 col-md-3 col-sm-8 mt-2 mb-2 border border-0 shadow-lg mb-2 mx-1">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <button type="button" class="btn btn-primary border border-0" data-id="<?= $animal['id'] ?>" style="background-color: #393424;" data-bs-toggle="modal" data-bs-target="#<?= $animal['prenom'] ?>">
                                                    Voir les détails
                                                </button>
                                            </div>
