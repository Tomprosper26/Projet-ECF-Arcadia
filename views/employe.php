        ...
        <ol class="list-group mt-2">
            <?php foreach ($services as $service) : ?>
                ...
                <div class="d-flex justify-content-left mt-2">
                    <button type="button" class="btn btn-primary border border-0" data-bs-toggle="modal" data-bs-target="#<?= $service['nom'] ?>">
                        Modifier
                    </button>
                </div>
                <div class="modal fade" id="<?= $service['nom'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
